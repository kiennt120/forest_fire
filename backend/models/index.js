...
const MS = sequelize.define('Monitoring_station', {
...
const Camera = sequelize.define('Camera', {
    ...
    status: {type: DataTypes.STRING, defaultValue: 'connect', allowNull: false, validate: {isIn: [['connect', 'disconnect']]}},
...
const Fire = sequelize.define('Fire', {
    ...
    status: {type: DataTypes.STRING, defaultValue: 'unconfirm', allowNull: false, validate: {isIn: [['unconfirm', 'confirm']]}},
    type_fire: {type: DataTypes.STRING, allowNull: false, validate: {isIn: [['fire', 'smoke']]}},
...
const Email_sended = sequelize.define('Email_sended', {
